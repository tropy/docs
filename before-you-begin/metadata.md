...
&#xNAN;_&#x50;roperty used_: purl.org/dc/elements/1.1/coverage\
&#xNAN;_&#x4C;abel_: This template replaces _coverage_ with the more specific term _location_ to reflect the specific form of the documents to which it will be applied. (The Dublin Core element coverage can refer to spatial or temporal features of a source.)
