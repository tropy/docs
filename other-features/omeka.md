...
4. You should get a box that generates a _key\_identity_ and a _key\_credential_. **Do not close this browser page until you have finished the process of installing and configuring the Tropy plugin.**![Screenshot of Omeka S interface showing the notice after an API key is created.](../.gitbook/assets/api-key)
