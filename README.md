...
* Tropy is not a platform for presenting your research online \(e.g., Omeka\). It operates on your personal computer, not on server. You can export your projects to platforms that can be used to present material online, including to Omeka -- not available in Beta version
...
Tropy currently works only with .jpg/.jpeg files. It does not work with any other image files like .tiff, .png, or .gif. You may need to convert your photos to JPG in order to use Tropy.
